...
#save plots
ggsave("../R_files/ggplot_publication_themes/plots/scatter_pub.pdf",plot = Scatter + theme_Publication(), width=9, height=5)
ggsave("../R_files/ggplot_publication_themes/plots/scatter_shapes_pub.pdf",plot = Scatter_shapes + theme_Publication() + scale_shape_custom(), width=9, height=5)
ggsave("../R_files/ggplot_publication_themes/plots/scatter_cb_pub.pdf",plot = Scatter_subset + theme_Publication() + scale_colour_colorblind(), width=9, height=5)
ggsave("../R_files/ggplot_publication_themes/plots/scatter_cb_shapes_pub.pdf",plot = Scatter_subset_shapes + theme_Publication() + scale_colour_colorblind() + scale_shape_custom(), width=9, height=5)
ggsave("../R_files/ggplot_publication_themes/plots/bar_cb_pub.pdf",plot = Bar + scale_fill_colorblind(), width=9, height=5)
